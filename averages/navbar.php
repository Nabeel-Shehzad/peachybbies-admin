<nav class="navbar shadow-sm navbar-expand-lg py-3 py-lg-0 px-lg-5">
    ...
    <div class="container-fluid justify-content-end">
        ...
        <div class="btn-group mr-2">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="sku.php">SKU by hour</a>
                <a class="dropdown-item" href="texture.php">Texture by hour</a>
                <a class="dropdown-item" href="breakTime.php">Break Time</a>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
